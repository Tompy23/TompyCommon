...
public class CommonFileSystemXmlApplicationContext extends FileSystemXmlApplicationContext 
{
    public CommonFileSystemXmlApplicationContext(String s) throws BeansException 
    {
        super(s);
    }
